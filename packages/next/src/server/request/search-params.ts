    ...
    switch (workUnitStore.type) {
      ...
      case 'prerender-dynamic':
        throw new InvariantError(
          'createSearchParamsFromClient should not be called in a dynamic prerender.'
        )
      case 'cache':
      case 'private-cache':
      case 'unstable-cache':
...
export function createPrerenderSearchParamsForClientPage(
  ...
  if (workUnitStore) {
    switch (workUnitStore.type) {
      ...
      case 'prerender-dynamic':
        throw new InvariantError(
          'createPrerenderSearchParamsForClientPage should not be called in a dynamic prerender.'
        )
      case 'cache':
      case 'private-cache':
      case 'unstable-cache':
